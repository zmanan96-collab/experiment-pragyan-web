      ...
      <div className="max-w-[1600px] mx-auto px-8 md:px-[4vw] lg:px-[6vw] xl:px-[8vw] relative z-10 w-full flex flex-col justify-start gap-4 md:gap-6 lg:gap-8">
        ...
        <div className="mb-4 pb-4 md:mb-2 md:pb-2 flex flex-col w-full">
          <div className="w-full text-center md:text-left relative z-10">
            <p className="text-[clamp(12px,0.85vw,16px)] text-[#a6a6a6] font-space font-light uppercase tracking-[0.3em] mb-3 md:mb-4">LET&apos;S WORK TOGETHER</p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-stretch md:items-start gap-4 md:gap-6 lg:gap-10 mb-4 md:mb-2 w-full max-w-[1000px] md:-mt-2 xl:-mt-4 relative z-30">
          ...
          <div className="flex-1 md:pr-6 lg:pr-10 py-2 md:border-r border-white/5 h-full text-center md:text-left flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-col gap-4 items-center md:items-start">
              <a href="tel:+919998081399" className="text-[16px] text-white/70 font-space font-light hover:text-[#4b3fd4] transition-colors flex items-start gap-2.5 group">
              ...
              <a href="mailto:CONNECT@MYPRAGYAN.COM" className="text-[16px] text-white/70 font-space font-light hover:text-[#4b3fd4] transition-colors flex items-start gap-2.5 group">
          ...
          <div className="flex-1 md:pl-6 md:pr-6 lg:pl-10 lg:pr-10 py-2 md:border-r border-white/5 h-full text-center md:text-left flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-col gap-4 items-center md:items-start">
              <a href="https://www.instagram.com/my_pragyan/" className="text-[16px] text-white/70 font-space font-light uppercase hover:text-[#4b3fd4] transition-colors flex items-center gap-2.5 group">
                <svg className="w-4 h-4 group-hover:stroke-[#4b3fd4] transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                Instagram
              </a>
              <a href="www.linkedin.com/in/dhruti-patel-pragyan" className="text-[16px] text-white/70 font-space font-light uppercase hover:text-[#4b3fd4] transition-colors flex items-center gap-2.5 group">
          ...
          <div className="flex-1 md:pl-6 lg:pl-10 py-2 h-full text-center md:text-left flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-col gap-3 items-center md:items-start">
              {['Home', 'Services', 'About', 'Culture'].map((item) => (
                <Link key={item} href={item === 'Home' ? '/' : `/${item.toLowerCase()}`} className="text-[16px] text-white/70 font-space font-light uppercase hover:text-[#4b3fd4] transition-colors duration-200 flex items-center group">
