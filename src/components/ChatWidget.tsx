      ...
      <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end">
        ...
        {!isOpen && (
          <button
            ...
            className="group flex items-center space-x-3.5 bg-agency-gold hover:bg-agency-gold-light text-agency-dark px-5 py-4 rounded-full shadow-premium shadow-gold-glow hover:shadow-2xl transition-all duration-300 hover:scale-105"
          >
            ...
            <span className="text-sm font-semibold tracking-wide font-sans pr-1">
